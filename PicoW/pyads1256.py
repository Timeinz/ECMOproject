...
class ADS1256:
    ...
    def __init__(self):
        ...
        self.drdy_pin = Pin(self.DRDY_PIN, Pin.IN)

        # Initialize the reset pin
        self.reset_pin = Pin(self.RESET_PIN, Pin.OUT)
        self.reset_pin.value(1)

        # Initialize PDWN pin
        self.pdwn_pin = Pin(self.PDWN_PIN, Pin.OUT)
        self.pdwn_pin.value(1)
        ...
        debug_print("SPI success " + str(self.spi))
    ...
    def WaitDRDY(self):
        ...
        drdy_level = self.drdy_pin.value()
